...
sanity_run = echo "sanity TTA run" && rm -rf nisin && metasmash --minimal antismash/test/integration/data/nisin.gbk

unit:
	$(sanity_run)
	echo "simple reuse test" && metasmash --reuse-results nisin/nisin.json
